...
function traerMessage(){
    $.ajax({
        url: "http://129.151.125.186:8080/api/Message/all",
        type: "GET",
        datatype: "JSON",
...
function guardarMessage(){
    ...
    $.ajax({
        type:"POST",
        url: "http://129.151.125.186:8080/api/Message/save",
        datatype:"JSON",
...
function editarMessage(){     
    ...
    $.ajax({         
        url: "http://129.151.125.186:8080/api/Message/update",
        type:"PUT",         
        datatype:"JSON",         
        contentType: "application/json; charset=utf-8",
        data:dataToSend,         
...
function borrarMessage(idMessage){
    $.ajax({
        ...
        contentType: "application/json; charset=utf-8",
        datatype:"JSON",
        url: "http://129.151.125.186:8080/api/Message/"+idMessage,
        // data:JSON.stringify(myData),
        success:function(respuesta){
            $("#resultadoMessage").empty();
            traerMessage(); 
