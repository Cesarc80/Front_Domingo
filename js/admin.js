...
function traerAdmin(){
    $.ajax({
        url: "http://129.151.125.186:8080/api/Admin/all",
        type: "GET",
        datatype: "JSON",
...
function guardarAdmin(){
    ...
    $.ajax({
        ...
        datatype:"JSON",
        url: "http://129.151.125.186:8080/api/Admin/save",
...
function editarAdmin(){     
    ...
    $.ajax({         
        ...
        datatype:"JSON",         
        data:dataToSend,         
        url: "http://129.151.125.186:8080/api/Admin/update",
        success:function(respuesta){
            if($("#id_Admin").val() =="" && 
                $("#name_Admin").val() == "" &&            
                $("#email_Admin").val() =="" &&           
...
function borrarAdmin(idAdmin){
    ...
    $.ajax({
        ...
        datatype:"JSON",
        url: "http://129.151.125.186:8080/api/Admin/"+idAdmin,
        // data:dataToSend,
        success:function(respuesta){
            $("#resultado").empty();
            traerAdmin(); 
