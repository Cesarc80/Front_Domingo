...
function traerCabin() {
    $.ajax({
        // url: "http://129.151.125.186/api/Cabin/all",
        url: "http://129.151.125.186:8080/api/Cabin/all",
        type: "GET",
        datatype: "JSON",
...
function guardarCabin() {
    ...
    $.ajax({
        ...
        // url: "http://129.151.125.186/api/Cabin/save",
        url: "http://129.151.125.186:8080/api/Cabin/save",
        success: function (respuesta) {
            $("#resultado").empty();
            $("#brand").val("");
            $("#rooms").val("");
...
function editarCabin() {
    ...
    $.ajax({
        // url: "http://129.151.125.186:8080/api/Cabin/update",
        url: "http://129.151.125.186:8080/api/Cabin/update",
        type: "PUT",
        datatype: "JSON",
        contentType: "application/json; charset=utf-8",
...
function borrarCabin(id) {
    $.ajax({
        ...
        contentType: "application/json; charset=utf-8",
        datatype: "JSON",
        // url: "http://129.151.125.186:8080/api/Cabin/" + id,
        url: "http://129.151.125.186:8080/api/Cabin/" + id,
        success: function (respuesta) {
            $("#resultado").empty();
            traerCabin();
...
function llenarCombo() {
    ...
    $.ajax({
        // url: "http://129.151.125.186:8080/api/Category/all",
        url: "http://129.151.125.186:8080/api/Category/all",
        type: "GET",
        datatype: "JSON",
        success: function (respuesta) {
