...
function mostarRStatus() {
    $.ajax({
        url: "http://129.151.125.186:8080/api/Reservation/report-status",
        type: "GET",
        datatype: "JSON",
...
function mostarTopCliente() {
    $.ajax({
        dataType: 'json',
        url: "http://129.151.125.186:8080/api/Reservation/report-clients",
        type: 'GET',
        success: function (respuesta) {
            let item = respuesta;
...
function mostrarReporteDate() {
    ...
    $.ajax({
        url: "http://129.151.125.186:8080/api/Reservation/report-dates/" + fechaInicio + "/" + fechaCierre,
        type: "GET",
        datatype: "JSON",
        success: function (respuesta) {
            console.log(respuesta);
