...
function traerReserva() {
    $.ajax({
        url: "http://129.151.125.186:8080/api/Reservation/all",
        type: "GET",
        datatype: "JSON",
...
function guardarReserva() {
    ...
    console.log(myData)
    $.ajax({
        url: "http://129.151.125.186:8080/api/Reservation/save",
        type: "POST",
        datatype: "JSON",
...
function editarReserva() {
    ...
    $.ajax({
        url: "http://129.151.125.186:8080/api/Reservation/update",
        type: "PUT",
        data: dataToSend,
        contentType: "application/json; charset=utf-8",
        datatype: "JSON",
...
function borrarReserva(idReservation) {
    $.ajax({
        ...
        datatype: "JSON",
        url: "http://129.151.125.186:8080/api/Reservation/" + idReservation,
        success: function (respuesta) {
            $("#resultadoReserva").empty();
            traerReserva();
...
function llenarCliente() {
    ...
    $.ajax({
        url: "http://129.151.125.186:8080/api/Client/all",
        type: "GET",
        datatype: "JSON",
        success: function (respuesta) {
            console.log(respuesta);
